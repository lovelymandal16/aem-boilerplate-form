...
## Environments
- Preview: https://main--aem-boilerplate-form--lovelymandal16.hlx.page/
- Live: https://main--aem-boilerplate-form--lovelymandal16.hlx.live/
...
1. Open the `aem-boilerplate-form` directory in your favorite IDE and start coding :)
